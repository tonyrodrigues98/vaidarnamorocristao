...
export const LEVEL_REWARDS: LevelReward[] = [
  ...
  { level: 2,  title: "Bônus rápido", description: "+1 moeda no próximo login diário.", icon: "Coins" },
  ...
  { level: 7,  title: "Recompensa de moedas", description: "+3 moedas no próximo login diário.", icon: "Coins" },
  ...
  { level: 15, title: "Bônus surpresa", description: "+5 moedas no próximo login diário.", icon: "Coins" },
  ...
  { level: 35, title: "Cofre de moedas", description: "+10 moedas no próximo login diário.", rarity: "epic", icon: "Coins" },
