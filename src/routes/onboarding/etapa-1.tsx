      ...
      .then(({ data }) => {
        if (data) {
          setForm({
            ...
            state: data.state ?? "",
            church: data.church ?? "",
            years_baptized: String(data.years_baptized ?? ""),
            bio: data.bio ?? "",
          });
        ...
        >
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-xs text-muted-foreground">
              <span className="font-medium text-foreground">Foto de perfil obrigatória</span> ·
              Clique para enviar (até 5MB)
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={form.sex}
                onValueChange={(v) => set("sex", v as "masculino" | "feminino")}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={form.marital}
                onValueChange={(v) => set("marital", v as "solteiro" | "divorciado")}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Selecione" />
                </SelectTrigger>
            ...
            <div className="space-y-2 sm:col-span-2">
              ...
              <Input
                ...
                min={0}
                max={100}
                value={form.years_baptized}
                onChange={(e) => set("years_baptized", e.target.value)}
                required
              />
            </div>
            <div className="space-y-2 sm:col-span-2">
              ...
              <Textarea
                ...
                placeholder="Conte um pouco sobre você, sua fé e seus sonhos..."
              />
            </div>
          </div>
