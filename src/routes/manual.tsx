...
const SECTIONS: SectionDef[] = [
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Esta plataforma foi criada para proporcionar conexões cristãs saudáveis, seguras e respeitosas. Aqui você poderá conhecer pessoas, criar amizades, conversar, demonstrar interesse e interagir com toda a comunidade de maneira simples e organizada.",
      },
      {
        kind: "p",
        text: "Este manual irá explicar detalhadamente cada área do sistema e como utilizá-las corretamente.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Na aba “Perfil”, você poderá editar e atualizar todas as suas informações pessoais.",
      },
      ...
      { kind: "h", text: "Preferências" },
      {
        ...
        items: [
          ...
          "interesse em pessoas com filhos",
        ],
      },
      ...
      { kind: "p", text: "Manter seu perfil atualizado aumenta:" },
      {
        kind: "ul",
        items: [
          "suas chances de receber interesses",
          "a qualidade dos matches",
          "a confiança dos outros usuários",
        ],
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "A comunidade deve permanecer respeitosa, saudável, organizada e compatível com valores cristãos. Comentários ofensivos poderão ser removidos pela administração.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "A conversa privada somente é liberada quando você demonstra interesse em alguém E a outra pessoa também demonstra interesse em você. Quando isso acontece, ocorre um MATCH e o chat privado é liberado automaticamente.",
      },
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "Caso goste de alguém, clique em “+ Interesse”. A pessoa receberá uma notificação informando seu interesse.",
      },
    ],
  },
  {
    id: "interesses",
    title: "Aba Interesses",
    icon: Sparkles,
    color: "from-pink-500/15 to-rose-500/10 text-pink-600 dark:text-pink-300",
    blocks: [
      {
        kind: "p",
        text: "Nesta aba ficam organizados os interesses que você recebeu e os interesses que você enviou.",
      },
      { kind: "h", text: "Interesses recebidos" },
      {
        kind: "p",
        text: "Aqui você verá quem demonstrou interesse em você. Você poderá ignorar OU demonstrar interesse de volta.",
      },
      { kind: "h", text: "Interesses enviados" },
      {
        kind: "p",
        text: "Você também poderá acompanhar todas as pessoas em que demonstrou interesse.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "A aba “Matches” reúne todas as pessoas com quem houve interesse recíproco.",
      },
      { kind: "h", text: "O que você pode fazer" },
      {
        kind: "ul",
      ...
      {
        kind: "p",
        text: "Caso deseje, você poderá remover o match. Ao desfazer, o chat poderá ser encerrado e a conexão será removida.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "Os devocionais poderão conter versículos, reflexões, mensagens bíblicas e textos diários.",
      },
    ],
  },
  {
    id: "compartilhar",
    title: "Aba Compartilhar",
    icon: Share2,
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "Ao clicar, será exibido o link do site. Você poderá copiar e enviar para amigos. O compartilhamento ajuda a comunidade a crescer.",
      },
    ],
  },
  {
    id: "bloqueados",
    title: "Aba Bloqueados",
    icon: Ban,
    color: "from-zinc-500/15 to-slate-500/10 text-zinc-600 dark:text-zinc-300",
    blocks: [
      {
        kind: "p",
        text: "Na aba “Bloqueados”, você poderá visualizar todas as pessoas bloqueadas por você.",
      },
      ...
      {
        kind: "p",
        text: "O bloqueio é recomendado em casos de desconforto, insistência, comportamento inadequado ou desrespeito.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "Ideal para uso noturno, conforto visual e economia de bateria em alguns dispositivos.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "O botão “Sair” serve para encerrar sua sessão e deslogar da plataforma com segurança.",
      },
      {
        kind: "p",
        text: "Recomendamos utilizar essa opção ao acessar em computadores públicos ou dispositivos compartilhados.",
      },
    ],
  },
  {
  ...
  {
    id: "dicas",
    title: "Dicas Para Melhor Experiência",
    icon: Lightbulb,
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "Perfis completos geram mais confiança, mais visualizações e mais interesses.",
      },
      ...
      {
        kind: "p",
        text: "Relacionamentos saudáveis são construídos com respeito, maturidade, diálogo e honestidade.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Nosso objetivo é criar um ambiente seguro, cristão, saudável, respeitoso e acolhedor.",
      },
      {
        kind: "p",
        text: "Desejamos que cada conexão criada aqui seja baseada em verdade, responsabilidade, princípios cristãos e boas intenções.",
      },
...
function highlight(text: string, q: string) {
  ...
  return parts.map((p, i) =>
    re.test(p) ? (
      <mark
        key={i}
        className="rounded bg-yellow-200 px-0.5 text-yellow-950 dark:bg-yellow-400/40 dark:text-yellow-50"
      >
        {p}
      </mark>
    ) : (
...
function SectionCard({ section, q }: { section: SectionDef; q: string }) {
  ...
  return (
    <section id={section.id} className="scroll-mt-24">
      <div
        className={`rounded-2xl border border-border bg-gradient-to-br ${section.color} p-5 md:p-6 shadow-sm`}
      >
      ...
      <main className="mx-auto max-w-4xl px-4 py-10">
        <div className="glass rounded-3xl p-6 md:p-10 shadow-elegant">
          ...
          <p className="mt-3 text-foreground/80">
            Guia completo das áreas do sistema. Use a busca abaixo para encontrar qualquer assunto
            rapidamente.
          </p>
