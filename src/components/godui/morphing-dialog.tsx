...
const MorphingDialogTrigger = React.forwardRef<HTMLDivElement, MorphingDialogTriggerProps>(
...
const MorphingDialogContent = React.forwardRef<HTMLDivElement, MorphingDialogContentProps>(
  ({ className, children, ...props }, ref) => {
    const { isOpen, close, layoutId, reduceMotion, portalContainer } = useMorphingDialog();
...
export type MorphingDialogCloseProps = React.ButtonHTMLAttributes<HTMLButtonElement>;

/** A button that closes the dialog. Renders a default ✕ when given no children. */
const MorphingDialogClose = React.forwardRef<HTMLButtonElement, MorphingDialogCloseProps>(
...
export { MorphingDialog, MorphingDialogClose, MorphingDialogContent, MorphingDialogTrigger };
